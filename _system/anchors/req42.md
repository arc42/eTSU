...
The 12 drawers fall into three groups: **Clean Start** (01 Vision/Ziele · 09 Assets ·
02 Stakeholder · 03 Scope), **Hauptteil / main part** (04 funktionale Anforderungen ·
08 Domänenbegriffe · 06 Qualitätsanforderungen · 07 Randbedingungen · 05 Modelle), and
**Management** (11 Roadmaps · 10 Teamstruktur · 12 Risiken & Annahmen).

## The 12 building blocks → where they live here

| # | req42 (DE / EN) | Home in this vault |
|---|-----------------|--------------------|
| 01 | Visionen & Ziele / Business Goals | Stakeholder goals ([[STK-...]]) + feature rationale; framed via [[PAM]] (req42's primary notation) or [[SMART]] |
| 02 | Stakeholder | `wiki/stakeholders/` |
| 03 | Scope & Abgrenzung / Scope | `wiki/context/` (boundary, in/out-of-scope) + `wiki/external-interfaces/` (neighbours); ADR-0009 |
...
| 05 | Modelle zur Unterstützung / Supporting Models | `wiki/use-cases/`, `wiki/activity-models/`, `wiki/data-models/` |
| 06 | Qualitätsanforderungen / Quality Requirements | `wiki/quality-requirements/` (ISO 25010 + ATAM) |
| 07 | Randbedingungen / Constraints | `wiki/constraints/` (arc42 categories) |
| 08 | Domänenbegriffe / Domain Terminology | `wiki/glossary/` (ubiquitous language) |
| 09 | Betriebsmittel & Personal / Assets | *out of scope* — project resourcing |
| 10 | Teamstruktur / Teams | *out of scope* — org/team setup |
| 11 | Roadmaps | *out of scope* — release planning |
| 12 | Risiken & Annahmen / Risks & Assumptions | `wiki/issues/` (`kind: risk`) + `> [!assumption]` flags |

Blocks 01–08 and 12 are modelled here; 09–11 are project-management concerns we
deliberately don't capture. Block 03 gained types in ADR-0009 — instances follow when
`raw/kontextdiagramm.md` is ingested.
